...
async def update_device(
    ...
    """Update a device's name, group assignment, or default asset.

    Args:
        device_id: The device ID to update.
        name: New display name for the device.
        group_id: UUID of the device's owning group, or null to ungroup. A device
            belongs to exactly one group, which is its authorization boundary.
